...
class MarketPress_Categories_Widget extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array( 'classname' => 'widget_categories mp_widget mp_widget_product_categories', 'description' => __( "Zeigt dir Produktkategorien aus deinem MarketPress-Shop als Liste oder Dropdown an.", 'mp' ) );
		parent::__construct( 'mp_categories_widget', __( 'Produktkategorien', 'mp' ), $widget_ops );
	}
	...
	function widget( $args, $instance ) {
		...
		$title	 = apply_filters( 'widget_title', empty( $instance[ 'title' ] ) ? __( 'Produktkategorien', 'mp' ) : $instance[ 'title' ], $instance, $this->id_base );
		...
		if ( $d ) {
			$cat_args[ 'show_option_none' ]	 = __( 'Kategorie auswaehlen', 'mp' );
	...
	function form( $instance ) {
		...
		<p><input type="checkbox" class="checkbox" id="<?php echo $this->get_field_id( 'dropdown' ); ?>" name="<?php echo $this->get_field_name( 'dropdown' ); ?>"<?php checked( $dropdown ); ?> />
			<label for="<?php echo $this->get_field_id( 'dropdown' ); ?>"><?php _e( 'Als Dropdown anzeigen', 'mp' ); ?></label><br />

			<input type="checkbox" class="checkbox" id="<?php echo $this->get_field_id( 'count' ); ?>" name="<?php echo $this->get_field_name( 'count' ); ?>"<?php checked( $count ); ?> />
			<label for="<?php echo $this->get_field_id( 'count' ); ?>"><?php _e( 'Produktanzahl anzeigen', 'mp' ); ?></label><br />
