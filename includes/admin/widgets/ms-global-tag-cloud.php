	...
	class MarketPress_Global_Tag_Cloud_Widget extends WP_Widget {
		...
		function __construct() {
			$widget_ops = array( 'classname'   => 'mp_widget mp_global_tag_cloud_widget',
			                     'description' => __( "Zeigt dir die global am haeufigsten genutzten Produkt-Tags aus deinen MarketPress-Shops als Tag-Cloud.", 'mp' )
			);
			parent::__construct( 'mp_global_tag_cloud_widget', __( 'Globale Produkt-Tag-Cloud', 'mp' ), $widget_ops );
		}
