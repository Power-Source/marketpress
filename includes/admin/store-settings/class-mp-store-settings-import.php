...
class MP_Store_Settings_Import {
	 ...
	 */
	private static function get_importer( $importer = 'wordpress-importer', $importer_name = 'ClassicPress' ) {
	...
	public function display_settings() {
		...
		<form method="post" id="mp-export-form">
			...
			<p>
				<?php esc_html_e( 'The import process uses the ClassicPress importer plugin.', 'mp' ); ?>
			</p>
