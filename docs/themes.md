...
2. Füge den benutzerdefinierten Theme-Header mit dem Namen deines Themes oben in der CSS-Datei hinzu:
  ...
  */
  ```
  Durch das Hinzufügen dieses Headers wird dein benutzerdefiniertes Theme im Dropdown-Menü auf der Seite **"MarketPress Einstellungen -> Darstellung"** angezeigt, sodass du es auswählen kannst.
